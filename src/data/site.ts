...
export const liberalEducation = {
	...
	pillars: [
		...
		{
			title: '被压迫者教育学',
			text: '巴西教育家保罗·弗莱雷在《被压迫者教育学》中提出：真正的学习发生在对话之中，而非单向灌输。知合圆桌以平等讨论取代传统课堂的权威结构，领读人与共读人围坐共思，在提问与回应中唤醒批判意识——这正是被压迫者教育学在文化平原地区的具体实践。',
		},
...
export const programs = [
	...
	},
	{
		...
		tag: '核心项目',
		description:
			'精简版的读书营，在寒假期间举办，一般持续三到五天。每位领读人负责一节 2–3 小时的讨论课，形式与读书会或沙龙更为贴近。',
		details: [],
	},
	{
		id: 'online',
...
export const partners = {
	...
	cases: [
		...
		{
			title: '知合 × 乐读读书会 · 遵义读书营',
			date: '2025.8',
			description:
				'与乐读读书会联合在贵州遵义落地暑期读书营，依托本地阅读社群与场地资源，为文化平原地区的青年搭建思辨、讨论与共学的社群空间。',
		},
		{
			title: '知合 × 立思辰留学 · 贵阳读书营',
			date: '2025.7',
			description:
				'与立思辰留学合作在贵阳举办知合读书营，连接在地教育网络与青年共学实践，让圆桌讨论与博雅阅读走进更多西南城市。',
		},
		{
			title: '知合 × 知见 · 哈尔滨读书营',
			date: '2025.8',
			description:
				'与知见合作在哈尔滨开展暑期读书营，将知合的领读人培训与圆桌共学方法带入东北文化平原城市，拓展北方地区的共学网络。',
		},
		{
			title: '知合 × 住所无定 · 慈利读书营',
			date: '2026.8',
			description:
				'与住所无定合作在湖南张家界慈利县举办读书营，在县域地区持续探索青年思辨讨论与共学社群的落地可能。',
		},
	],
} as const;
